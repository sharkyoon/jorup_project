...
int NEW_PAGE_HEAD()
{
	...
	int temp = rand() % POOL_SIZE;
cout<<"new offset "<<temp<<endl;
	return temp;
}
	...
	mstate av = get_malloc_state();
	  ...
	  */
	  ...
	  if (in_smallbin_range(nb)) {
	    idx = smallbin_index(nb); //주어진 크기(nb)에 맞는 small bin의 인덱스
	    bin = bin_at(av,idx); // 해당 index의 bin
